...
<body>
  ...
  <main class="container">
    ...
    <section class="contact" id="contact">
      ...
      <form class="contact__wrapper" action="" method="post">
        <div class="contact__item js-float">
          <label class="contact__label" for="username">お名前</label>
          <input class="contact__input" type="text" name="username" id="username" value="" required />
        </div>
        <div class="contact__item js-float">
          <label class="contact__label" for="email">メールアドレス</label>
          <input class="contact__input" type="email" name="email" id="email" value="" required />
        </div>
        <div class="contact__item js-float">
          <label class="contact__label" for="type">お問い合わせ内容</label>
          <textarea class="contact__text" name="content" id="content" cols="30" rows="10"></textarea>
        </div>
        <div class="contact__item js-float">
  ...
  <footer class="footer">
    <h1 class="footer__logo">
      <img class="footer__icon" src="images/neptune.png" alt="#" />Suto
      Website
    </h1>
